                ...
                <div class="panel-body">
                    ...
                    <div class="container">
                        <div class="row">
                          ...
                          <div class="card text-black card-outline-primary" >
                              <div class="card-header bg-primary">
                                <h6 class="text-white text-center mb-3 button" data-target="#myModal" onclick="modal('{{$post->title}}', '{{$post->post_text}}')" data-toggle="modal" href="#">{{$post->title}}</h6>
                              </div>
